          ...
          <form class="form-horizontal" action="{{ route('product_save') }}" id="general-form" name="general-form" method="POST"  novalidate>
            ...
            <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <fieldset class="form-group position-relative has-icon-left">
                        <select class="select2 form-control" id="country" name="country" required data-validation-required-message="This field is required">
                            ...
                            <option value="{{$item->id}}" {{$product->country == $item->id?'selected':''}}>{{ $item->title }}</option>
                            @endforeach
                        </select>
                        <div class="form-control-position">
                          <i class='bx bx-search'></i>
                    ...
                    <fieldset class="form-group position-relative has-icon-left">
                      <select class="select2 form-control" id="city" name="city" required data-validation-required-message="This field is required">
                          @foreach($city as $item)
                            <option value="{{$item->id}}" {{ $product->city == $item->id?'selected':''}}>{{ $item->title }}</option>
                          @endforeach
                      </select>
                      <div class="form-control-position">
                        <i class='bx bx-search'></i>
              ...
              <div class="col-md-6">
                <h6>Location</h6>
                <fieldset class="form-group position-relative has-icon-left">
                  <input type="text" id="location" name="location" value="{{ $product->location }}" class="form-control" data-validation-required-message="This field is required" placeholder="Select Location">
                  <div class="form-control-position">
                      <i class='bx bx-info-circle'></i>
                  </div>
                </fieldset>
