...
{{-- title --}}
@section('title','Travel Quoting System | Edit Itineary(Basic)')
{{-- venodr style --}}
    ...
    <div class="card-content">
      <div class="card-body">
        <form class="form-horizontal" method="post" action="{{route('itinerary_create_basic.with_enquiry_id')}}" novalidate>
          @csrf
          <input type="hidden" name="enquiry_id" value="{{ $itinerary->enquiry_id }}">
          ...
          <div class="row">
            <div class="col-md-6 col-sm-6">
              ...
              <fieldset class="form-group position-relative has-icon-left">
                  <div class="controls">
                      <input type="text" class="form-control" id="title" name="title" value="{{ $itinerary->title }}" placeholder="Itinerary Title" required data-validation-required-message="This Title field is required" aria-invalid="false">
                  </div>
            ...
            <div class="col-md-2 col-sm-2">
              ...
              <fieldset class="form-group position-relative has-icon-left">
                  ...
                  @endphp
                  <input type="text" class="form-control showdropdowns" placeholder="Select duration" id="duration" name="duration" value="{{ $duration }}" required data-validation-required-message="This Duration field is required" aria-invalid="false">
                  <div class="form-control-position">
          ...
          <div class="row">
            <div class="col-12 col-sm-12 col-md-12">
              <h6>Note:</h6>
              <textarea class="form-control" rows="6" placeholder="Please type note about enquiry." id="note" name="note">
                {{ $itinerary->note }}
              </textarea>
            </div>
          </div>
